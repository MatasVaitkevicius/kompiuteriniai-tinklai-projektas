...
<div class="container">
    <div class="row justify-content-center">
        <div><h3>Sveiki Atvyke Į Kambarių Registracijos Sistemą!</h3></div>
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Jeigu Norite Filtruoti Duomenis, Užpildykite Informaciją Čia') }}</div>
                <div class="card-body">
                <form>
...
<div><h3>Jeigu Norite Rezervuoti Kambarį, Jums Prireiks Užsiregistruoti!</h3></div>
